...
Route::group(['middleware' => ['role:administrator,user']], function () {
    ...
    Route::post('/tempat/edit', [TempatController::class, 'edit']);
    Route::post('/tempat/update', [TempatController::class, 'update']);
    Route::post('/tempat/{kode_tempat}/delete', [TempatController::class, 'delete']);
