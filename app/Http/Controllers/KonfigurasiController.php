...
class KonfigurasiController extends Controller
{
    ...
    public function jamkerjadept()
    {
        ...
        $jamkerjadept = DB::table('konfigurasi_jk_dept')
            ->join('tempat', 'konfigurasi_jk_dept.kode_tempat', '=', 'tempat.kode_tempat')
    ...
    public function createjamkerjadept()
    {
        ...
        return view('konfigurasi.createjamkerjadept', compact('jamkerja', 'tempat', 'departemen'));
    }
    ...
    public function storejamkerjadept(Request $request)
    {
        ...
        $hari = $request->hari;
        $kode_jam_kerja = $request->kode_jam_kerja;
        $kode_jk_dept = "J" . $kode_tempat . $kode_dept;
    ...
    public function editjamkerjadept($kode_jk_dept)
    {
        ...
        return view('konfigurasi.editjamkerjadept', compact('jamkerja', 'tempat', 'departemen', 'jamkerjadept', 'jamkerjadept_detail'));
    }
    ...
    public function showjamkerjadept($kode_jk_dept)
    {
        ...
        return view('konfigurasi.showjamkerjadept', compact('jamkerja', 'tempat', 'departemen', 'jamkerjadept', 'jamkerjadept_detail'));
    }
