...
class HariliburController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('harilibur.create', compact('tempat'));
    }
    ...
    public function edit(Request $request)
    {
        ...
        $tempat = DB::table('tempat')->orderBy('kode_tempat')->get();
        return view('harilibur.edit', compact('tempat', 'harilibur'));
    }
    ...
    public function setkaryawanlibur($kode_libur)
    {
        $harilibur = DB::table('harilibur')
            ->join('tempat', 'harilibur.kode_tempat', '=', 'tempat.kode_tempat')
    ...
    public function getsetlistkaryawanlibur($kode_libur)
    {
        ...
        $karyawan = DB::table('karyawan')
            ...
            ->where('kode_tempat', $harilibur->kode_tempat)
