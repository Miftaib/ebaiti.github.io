...
<body class="A4">
    ...
    <section class="sheet padding-10mm">
        ...
        <table style="width: 100%">
            <tr>
                <td style="width: 30px">
                    <img src="{{ asset('assets/img/s.png') }}" width="70" height="70" alt="">
                </td>
                <td>
                    <span id="title">
                        LAPORAN PRESENSI GURU DAN KARYAWAN<br>
                        PERIODE {{ strtoupper($namabulan[$bulan]) }} {{ $tahun }}<br>
                        SMK BAITUL ATIEQ <br>
                    </span>
                    <span><i>Jln.Raya Nganjuk - Sawahan, Ds. Cepoko, Kec. Brebek, Kab. Nganjuk</i></span>
                </td>
            </tr>
        </table>
        ...
        <table width="100%" style="margin-top:100px">
            <tr>
                <td colspan="2" style="text-align: right">Brebek, {{ date('d-m-Y') }}</td>
            </tr>
            <tr>
                <td style="text-align: center; vertical-align:bottom" height="100px">
                    <u>Kepala Sekolah</u><br>
                    <i><b>Budi Aswin,S.Pd</b></i>
                </td>
                <td style="text-align: center; vertical-align:bottom">
                    <u>Tata Usaha</u><br>
                    <i><b>Desy Kristanti,S,Pd</b></i>
                </td>
            </tr>
        </table>
    </section>
