...
@section('content')
                            ...
                            <div class="iconpresensi">
                                @if ($d->status == 'i')
                                    <ion-icon name="document-outline"
                                        style="font-size: 48px; color:slategrey"></ion-icon>
                                @elseif($d->status == 's')
    ...
    <div class="fab-button animate bottom-right dropdown" style="margin-bottom:70px">
        <a href="#" class="fab bg-secondary" data-toggle="dropdown">
            <ion-icon name="add-outline" role="img" class="md hydrated" aria-label="add outline"></ion-icon>
        </a>
        <div class="dropdown-menu">
            <a class="dropdown-item bg-secondary" href="/izinabsen">
                <ion-icon name="document-outline" role="img" class="md hydrated" aria-label="image outline"></ion-icon>
                <p>Izin Absen</p>
            </a>

            <a class="dropdown-item bg-secondary" href="/izinsakit">
                <ion-icon name="medkit-outline" role="img" class="md hydrated"
                    aria-label="videocam outline"></ion-icon>
                <p>Sakit</p>
            </a>
            <a class="dropdown-item bg-secondary" href="/izincuti">
                <ion-icon name="calendar-outline" role="img" class="md hydrated"
                    aria-label="videocam outline"></ion-icon>
                <p>Cuti</p>
            </a>
            {{-- <a class="dropdown-item bg-secondary" href="/persetujuanizin">
                <ion-icon name="calendar-outline" role="img" class="md hydrated"
                    aria-label="videocam outline"></ion-icon>
