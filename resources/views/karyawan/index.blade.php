                                            ...
                                            <div class="col-4">
                                                <div class="form-group">
                                                    <input type="text" name="nama_karyawan" id="nama_karyawan"
                                                        class="form-control" placeholder="Nama Karyawan / Guru"
                                                ...
                                                {{-- <div class="col-3">
                                                    <div class="form-group">
                                                        <select name="kode_tempat" id="kode_tempat" class="form-select">
                                                            ...
                                                            @foreach ($tempat as $d)
                                                                <option
                                                                    {{ Request('kode_tempat') == $d->kode_tempat ? 'selected' : '' }}
                                                                    value="{{ $d->kode_tempat }}">
                                                                    {{ strtoupper($d->nama_tempat) }}</option>
                                                            @endforeach
                                                        </select>
                                                    </div>
                                                </div> --}}
                            ...
                            <div class="col-12">
                                <div class="input-icon mb-3">
                                    ...
                                    <input type="text" maxlength="5" value="" id="nik"
                                        class="form-control" placeholder="Kode Guru / Karyawan" name="nik">
                                </div>
                            </div>
                        </div>
                        <div class="row">
                        ...
                        <div class="row mt-2">
                            <div class="col-12">
                                <select name="kode_tempat" id="kode_tempat" class="form-select">
                                    ...
                                    @foreach ($tempat as $d)
                                        <option value="{{ $d->kode_tempat }}">{{ strtoupper($d->nama_tempat) }}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
    ...
    <script>
        $(function() {
            ...
            $("#frmKaryawan").submit(function() {
                ...
                var kode_tempat = $("#frmKaryawan").find("#kode_tempat").val();
                if (nik == "") {
