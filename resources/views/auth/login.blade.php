...
<head>
    ...
    <link rel="icon" type="image/png" href="{{ asset('s.png') }}" sizes="32x32">
...
<body class="bg-white">
    ...
    <div id="appCapsule" class="pt-0">
        ...
        <div class="login-form mt-1">
            <div class="section">
                <img src="{{ asset('assets/img/login/s.png') }}" alt="image" class="form-image">
            </div>
                ...
                <form action="/proseslogin" method="POST">
                    ...
                    <div class="form-group boxed">
                        <div class="input-wrapper">
                            <input type="text" name="nik" class="form-control" id="nik" placeholder="Kode Guru">
                            <i class="clear-input">
                    ...
                    <div class="form-button-group">
                        <button type="submit" class="btn btn-secondary btn-block btn-lg">Log in</button>
                    </div>
