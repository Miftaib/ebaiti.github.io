        ...
        <div class="collapse navbar-collapse" id="sidebar-menu">
            <ul class="navbar-nav pt-lg-3">
                ...
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle {{ request()->is(['karyawan', 'departemen', 'tempat']) ? 'show' : '' }}"
                        href="#navbar-base" data-bs-toggle="dropdown" data-bs-auto-close="false" role="button"
                        aria-expanded="{{ request()->is(['karyawan', 'departemen', 'tempat']) ? 'true' : '' }}">
                        <span class="nav-link-icon d-md-none d-lg-inline-block">
                    ...
                    <div
                        class="dropdown-menu {{ request()->is(['karyawan', 'departemen', 'tempat', 'cuti']) ? 'show' : '' }}">
                        <div class="dropdown-menu-columns">
                            <div class="dropdown-menu-column">
                                ...
                                @role('administrator', 'user')
                                    ...
                                    <a class="dropdown-item {{ request()->is(['tempat']) ? 'active' : '' }}"
                                        href="/tempat">
                                        Tempat
                                    </a>
