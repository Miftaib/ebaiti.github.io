...
@section('content')
    ...
    <div class="section" id="user-section" style="background-color:slategray">
                    ...
                    <div id="rekappresensi">
                        ...
                        <div class="row">
                            <div class="col-3">
                                <div class="card">
                                    <div class="card-body text-center"
                                        style="padding: 12px 12px !important; line-height:0.5rem">
                                        <span class="badge bg-danger"
                                            style="position: absolute; top:3px; right:1px; font-size:0.6rem; z-index:999">{{ $rekappresensi->jmlhadir }}</span>
                                        <ion-icon name="accessibility-outline" style="font-size: 1.6rem;"
                                            class="text-secondary mb-1"></ion-icon>
                                        <br>
                            ...
                            <div class="col-3">
                                <div class="card">
                                    <div class="card-body text-center"
                                        style="padding: 12px 12px !important; line-height:0.5rem">
                                        <span class="badge bg-danger"
                                            style="position: absolute; top:3px; right:1px; font-size:0.6rem; z-index:999">
                                            {{ $rekappresensi->jmlizin }}
                                        </span>
                                        <ion-icon name="newspaper-outline" style="font-size: 1.6rem;"
                                            class="text-secondary mb-1"></ion-icon>
                                        <br>
                                        <span style="font-size: 0.7rem; font-weight:500">Izin</span>
                                    </div>
                                </div>
                            </div>
                            <div class="col-3">
                            ...
                            <div class="col-3">
                                <div class="card">
                                    <div class="card-body text-center"
                                        style="padding: 12px 12px !important; line-height:0.5rem">
                                        <span class="badge bg-danger"
                                            style="position: absolute; top:3px; right:1px; font-size:0.8rem; z-index:999">
                                            {{ $rekappresensi->jmlcuti }}
                                        </span>
                                        <ion-icon name="accessibility-outline" style="font-size: 1.6rem;"
                                            class="text-secondary mb-1"></ion-icon>
                                        <br>
                                        <span style="font-size: 0.7rem; font-weight:500">Tidak Hadir</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <li>
                                <div class="item">
                                    @if (!empty(Auth::guard('karyawan')->user()->foto))
                                        @php
                                            $path = Storage::url(
                                                'uploads/karyawan/' . Auth::guard('karyawan')->user()->foto,
                                            );
                                        @endphp
